        ...
        m(
          ...
          m(
            'a.modal-close.waves-effect.waves-green.btn-flat',
            {
              onclick: () => {
                chosenTab === 'Group'
                  ? vnode.attrs.actions.createGroup(groupName)
                  : chosenTab === 'POI'
                  ? vnode.attrs.actions.addDrawingsToLayer(layerIndex)
                  : chosenTab === 'Chemical Hazard'
                  ? vnode.attrs.actions.createCHT(
                      source,
                      (vnode.attrs.state.app.latestDrawing.geometry as Point).coordinates
                    )
                  : chosenTab === 'Population'
                  ? vnode.attrs.actions.createPopulatorRequest()
